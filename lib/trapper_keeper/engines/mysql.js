...
MySQL.prototype.find = function find(conditions, options, namespace, callback) {
  callback = typeof options === 'string' ? namespace : callback;
  namespace = typeof options === 'string' ? options : namespace;
