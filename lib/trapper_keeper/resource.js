...
Resource.prototype.save = function save(id, attrs, callback) {
  this.connection.save(id, attrs, this.namespace, callback);
};
...
Resource.prototype.find = function find(conditions, options, callback) {
  var namespace;

  namespace = typeof options === 'function' ? options : this.namespace;
  options = typeof options === 'function' ? this.namespace  : options;

  this.connection.find(conditions, options, namespace, callback);
};
...
// Engine
// find(conditions, options, namespace, callback)
// find(conditions, namespace, callback)